theory Chapter15_3_Typechecking
imports Chapter15_2_Language
begin
...
| tc_lam [simp]: "is_type t1 \<Longrightarrow> typecheck (extend gam t1) e t2 \<Longrightarrow> 
...
| tc_abort [simp]: "is_type t \<Longrightarrow> typecheck gam e Void \<Longrightarrow> typecheck gam (Abort t e) t"
...
| tc_inl [simp]: "is_type t1 \<Longrightarrow> is_type t2 \<Longrightarrow> typecheck gam e t1 \<Longrightarrow> 
    typecheck gam (InL t1 t2 e) (Sum t1 t2)"
| tc_inr [simp]: "is_type t1 \<Longrightarrow> is_type t2 \<Longrightarrow> typecheck gam e t2 \<Longrightarrow> 
    typecheck gam (InR t1 t2 e) (Sum t1 t2)"
| tc_strgen [simp]: "typecheck gam e t \<Longrightarrow> typecheck (extend gam t) e1 Nat \<Longrightarrow> 
    typecheck (extend gam t) e2 t \<Longrightarrow> typecheck gam (Strgen t e e1 e2) Stream"
| tc_hd [simp]: "typecheck gam e Stream \<Longrightarrow> typecheck gam (Hd e) Nat"
| tc_tl [simp]: "typecheck gam e Stream \<Longrightarrow> typecheck gam (Tl e) Stream"
...
inductive_cases [elim!]: "typecheck gam (Strgen t1 e e1 e2) t"
inductive_cases [elim!]: "typecheck gam (Hd e) t"
inductive_cases [elim!]: "typecheck gam (Tl e) t"
