theory Chapter15_5_Abbreviations
imports Chapter15_4_Evaluation
begin
...
lemma tc_null: "is_type t \<Longrightarrow> typecheck gam (Null t) (Option t)"
  by simp

lemma tc_just: "is_type t \<Longrightarrow> typecheck gam e t \<Longrightarrow> typecheck gam (Just t e) (Option t)"
  by simp
