...
object ExprParser {
  ...
  private val tyParser : Parser[Type] = numTyParser || arrTyParser || prodParser || unitParser || sumParser || voidParser
  ...
  val exprParser : Parser[Expr] =
    varParser || numParser || sParser || letParser || apParser || fundefParser || lamParser || ifzParser || fixParser || pairParser ||
      prlParser || prrParser || trivParser || abortParser || inlParser || inrParser || caseParser
